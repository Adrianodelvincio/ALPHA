...
\begin{frame}{Results for point 1 :$\mu_{cosmic} = 0.046$, $\epsilon = 0.775$}
...
\begin{frame}{Results for point 2 :$\mu_{cosmic} = 0.01$, $\epsilon = 0.638$}
...
\begin{frame}{Results for point 2 :$\mu_{cosmic} = 0.23$, $\epsilon = 0.86$}

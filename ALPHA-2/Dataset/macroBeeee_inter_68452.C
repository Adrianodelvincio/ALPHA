{
  ...
  TA2Plot plotMW1(true);  plotMW1.AddDumpGates(irun, {"MW 2PA Dump"}, {-1});   plotMW1.LoadData();
  plotMW1.ExportCSV(TString::Format("r%d_uw_exp_freq1",irun).Data());
  
  TA2Plot plotMW2(true);  plotMW2.AddDumpGates(irun, {"MW 2PF Dump"}, {-1});   plotMW2.LoadData();

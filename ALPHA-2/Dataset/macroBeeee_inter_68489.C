{
  ...
  int irun= 68489; // 68489 ; // run 68498
  ...
  TA2Plot plotUW0(true);  plotUW0.AddDumpGates(irun, {"Microwave Dump"}, {0});   plotUW0.LoadData();
  plotUW0.ExportCSV(TString::Format("r%d_postlaser_uw_0",irun).Data());
  
  TA2Plot plotUW1(true);  plotUW1.AddDumpGates(irun, {"Microwave Dump"}, {1});   plotUW1.LoadData();
  ...
  TA2Plot plot6(true);   plot6.AddTimeGate(irun, tcyclestop, spillsUW.at(0).GetStartTime());   plot6.LoadData();
  plot6.ExportCSV(TString::Format("r%d_postlaser_preuw",irun).Data()); 

  TA2Plot plot7(true);   plot7.AddTimeGate(irun, spillsUW.at(0).GetStopTime(), spillsUW.at(1).GetStartTime());   plot7.LoadData();
  plot7.ExportCSV(TString::Format("r%d_inter_uw",irun).Data()); 

  TA2Plot plot5(true);   plot5.AddTimeGate(irun, spillsUW.at(1).GetStopTime(), spillsFRD.at(0).GetStartTime());   plot5.LoadData();
